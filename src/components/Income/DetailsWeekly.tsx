...
export default function DetailsWeekly({ id }: { id: string }) {
      ...
      <div className="h-screen relative">
        <div className="my-4 ">
          <h1 className="font-sans font-medium text-gray-500">
            <div className="flex gap-2">
              ...
              <span className="font-sans">Weekly Income details</span>
            </div>
          </h1>
        ...
        <div>
          <h4 className="font-sans font-normal">
            Week No: #{singleEmployee?.employeeId}
          </h4>
          <h4 className="font-sans font-normal">
            Total Users: {singleEmployee?.trxId}
          </h4>
          <h4 className="font-sans font-normal">
            Amount: {singleEmployee?.amount}
          </h4>
          <h4 className="font-sans font-normal">
            Date: {singleEmployee?.dateTime}
          </h4>
        </div>
